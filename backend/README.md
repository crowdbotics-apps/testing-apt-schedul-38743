...
## Project Structure
    ...
    ├── testing_apt_schedul_38743  # Django project configurations
...
1. Clone this repo and `cd testing_apt_schedul_38743`
...
2. Clone this repo and `cd testing_apt_schedul_38743`
